...
import com.example.dev00.myall.POJOs.ValidationRespond
...
class LoginActivity : AppCompatActivity(), LoaderCallbacks<Cursor> {
    ...
    private fun onBindingView() {
        firebaseAuth = FirebaseAuth.getInstance()
        txt_password.setOnEditorActionListener(TextView.OnEditorActionListener { _, id, _ ->
    ...
    /**
     * HuynhHQ
     * Validate information from user input
     */
    private fun attemptLogin() {
        ...
        var result = validInfomation()

        var cancel = result.IsCancel
        var focusView: View? = result.FocusView
    ...
    inner class UserLoginTask internal constructor(private val mEmail: String, private val mPassword: String) : AsyncTask<Void, Void, Boolean>() {
        ...
        override fun onPreExecute() {
            super.onPreExecute()
            Utils.createToast(context, "Start")
        }
        ...
        override fun onPostExecute(success: Boolean?) {
            ...
            if (success!!) {
                ...
                txt_password.error = getString(R.string.error_incorrect_password)
